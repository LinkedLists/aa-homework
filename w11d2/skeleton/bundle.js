...
/* harmony default export */ __webpack_exports__["default"] = (giphysReducer); //requires default according to root
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  $.ajax({
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=u2XUDKI3ZuZrY9RXfHw35egvUdvm335B&limit=2"),
    method: "GET"
  });
};
